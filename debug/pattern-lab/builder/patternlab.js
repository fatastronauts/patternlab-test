/* 
 * patternlab-node - v0.1.0 - 2014-02-04 
 * 
...
module.exports = function(grunt) {	
	grunt.registerTask('patternlab', 'create design systems with atomic design', function(arg) {
		...
		var patternlab = {};
		patternlab.data = grunt.file.readJSON('./debug/pattern-lab/source/_data/data.json');
		patternlab.listitems = grunt.file.readJSON('./debug/pattern-lab/source/_data/listitems.json');
		patternlab.header = grunt.file.read('./debug/pattern-lab/source/_patternlab-files/pattern-header-footer/header.html');
		patternlab.footer = grunt.file.read('./debug/pattern-lab/source/_patternlab-files/pattern-header-footer/footer.html');
		patternlab.patterns = [];
		...
		grunt.file.recurse('./debug/pattern-lab/source/_patterns', function(abspath, rootdir, subdir, filename){
			...
			if(patternIndex === -1){
				...
				if(grunt.util._.str.include(filename, 'json')){
					...
					grunt.file.write('./debug/pattern-lab/public/patterns/' + flatPatternPath, patternlab.header + currentPattern.patternPartial + currentPatternFooter);
		...
		var styleguideTemplate = grunt.file.read('./debug/pattern-lab/source/_patternlab-files/styleguide.mustache');
		var styleguideHtml = mustache.render(styleguideTemplate, {partials: patternlab.patterns});
		grunt.file.write('./debug/pattern-lab/public/styleguide/html/styleguide.html', styleguideHtml);

		//build the patternlab website
		var patternlabSiteTemplate = grunt.file.read('./debug/pattern-lab/source/_patternlab-files/index.mustache');
		...
		//patternNav
		var patternNavTemplate = grunt.file.read('./debug/pattern-lab/source/_patternlab-files/partials/patternNav.mustache');
		var patternNavPartialHtml = mustache.render(patternNavTemplate, patternlab);

		//ishControls
		var ishControlsTemplate = grunt.file.read('./debug/pattern-lab/source/_patternlab-files/partials/ishControls.mustache');
		var ishControlsPartialHtml = mustache.render(ishControlsTemplate);

		//patternPaths
		var patternPathsTemplate = grunt.file.read('./debug/pattern-lab/source/_patternlab-files/partials/patternPaths.mustache');
		var patternPathsPartialHtml = mustache.render(patternPathsTemplate, {'patternPaths': JSON.stringify(patternlab.patternPaths)});

		//viewAllPaths
		var viewAllPathsTemplate = grunt.file.read('./debug/pattern-lab/source/_patternlab-files/partials/viewAllPaths.mustache');
		var viewAllPathersPartialHtml = mustache.render(viewAllPathsTemplate, {'viewallpaths': JSON.stringify(patternlab.viewAllPaths)});

		//websockets
		var websocketsTemplate = grunt.file.read('./debug/pattern-lab/source/_patternlab-files/partials/websockets.mustache');
		var config = grunt.file.readJSON('./debug/pattern-lab/config/config.json');
		...
		grunt.file.write('./debug/pattern-lab/public/index.html', patternlabSiteHtml);

		//debug
		var outputFilename = './debug/pattern-lab/patternlab.json';
